 ...
 void _filtrar(){
    ...
    setState(() {
      _filtroUsuario = _usuarios.where((user) {
        return
        user.nome.toLowerCase().contains(busca) || //filtra pelo o nome
        user.email.toLowerCase().contains(busca);//pelo email
      }).toList();//converte para lista
    });
  }

  void _openForm({Usuario? user}) async { // usuario opcional
        ...
        child: Column(
          children: [
            TextField(
              ...
              decoration: InputDecoration(labelText: "Pesaquisar Usuario"),
